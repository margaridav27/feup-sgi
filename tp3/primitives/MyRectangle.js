...
export class MyRectangle extends CGFobject {
   ...
   * @param {string} id - rectangle's ID
   * @param {float} x1 - x coordinate of rectangle's corner 1
   * @param {float} x2 - x coordinate of rectangle's corner 2
   * @param {float} y1 - y coordinate of rectangle's corner 1
   * @param {float} y2 - x coordinate of rectangle's corner 2
   */
