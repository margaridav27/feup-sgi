...
export class MyRectangle extends CGFobject {
  ...
  initBuffers() {
    ...
    this.indices = [0, 1, 2, 1, 3, 2, 2, 1, 0, 2, 3, 1];
    ...
    this.defaultTexCoords = [0, this.y2, this.x2, this.y2, 0, 0, this.x2, 0];

    this.texCoords = [0, this.y2, this.x2, this.y2, 0, 0, this.x2, 0];
