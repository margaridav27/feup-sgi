...
export class MyTriangle extends CGFobject {
  ...
  initBuffers() {
    ...
    const a = Math.sqrt((this.v1[0] - this.v2[0]) ^ (2 + (this.v1[1] - this.v2[1])) ^ (2 + (this.v1[2] - this.v2[2])) ^ 2); // dist12
    const b = Math.sqrt((this.v2[0] - this.v3[0]) ^ (2 + (this.v2[1] - this.v3[1])) ^ (2 + (this.v2[2] - this.v3[2])) ^ 2); // dist23
    const c = Math.sqrt((this.v1[0] - this.v3[0]) ^ (2 + (this.v1[1] - this.v3[1])) ^ (2 + (this.v1[2] - this.v3[2])) ^ 2); // dist13
